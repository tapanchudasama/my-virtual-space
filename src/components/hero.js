...
import { Heading, Flex, Text, Container, Box, Stack } from "@chakra-ui/react";
...
const Hero = () => {
  ...
  const { name, description, socialMedia } = siteMetadata;
  const { twitter, mail, reddit, github, linkedin } = socialMedia;
  ...
  return (
    <Container maxWidth="6xl" position="relative">
      ...
      >
        ...
        >
          {twitter && (
            <a key="twitter" href={twitter} target="_blank">
              <Icon viewBox="0 0 512 512" w={["6", "8"]} h={["6", "8"]}>
                <path
                  fill="currentColor"
          ...
          {linkedin && (
            <a key="linkedin" href={linkedin} target="_blank">
              <Icon viewBox="0 0 512 512" w={["6", "8"]} h={["6", "8"]}>
                <path
                  fill="currentColor"
          ...
          {reddit && (
            <a key="reddit" href={reddit} target="_blank">
              <Icon viewBox="0 0 512 512" w={["6", "8"]} h={["6", "8"]}>
                <path
                  fill="currentColor"
          ...
          {mail && (
            <a key="mail" href={mail} target="_blank">
              <Icon viewBox="0 0 512 512" w={["6", "8"]} h={["6", "8"]}>
                <path
                  fill="currentColor"
